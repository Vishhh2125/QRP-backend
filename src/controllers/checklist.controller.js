...
//     }
//   };
//   export { listChecklistsForStage, getChecklistById ,createChecklistForStage,updateChecklist,deleteChecklist,approveChecklist,submitChecklist,requestChanges,getChecklistHistory};
...
const updateChecklist = asyncHandler(async (req, res) => {
  ...
  const checklist = await Checklist.findByIdAndUpdate(id, { $set: update }, {
    new: true,
    runValidators: true,
  });
...
const submitChecklist = asyncHandler(async (req, res) => {
  ...
  return res
    .status(200)
    .json(new ApiResponse(200, checklist, "Checklist submitted successfully"));
});

/* =====================================================
   APPROVE CHECKLIST
===================================================== */
const approveChecklist = asyncHandler(async (req, res) => {
  const { id } = req.params;
  ...
  return res
    .status(200)
    .json(new ApiResponse(200, checklist, "Checklist approved successfully"));
});
...
const requestChanges = asyncHandler(async (req, res) => {
  ...
  return res
    .status(200)
    .json(
      new ApiResponse(200, checklist, "Changes requested successfully")
    );
});
